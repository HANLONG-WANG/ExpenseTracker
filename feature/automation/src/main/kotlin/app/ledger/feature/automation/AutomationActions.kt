...
public data class AutomationActions(
    ...
    val onTemplateFilter: (AutomationTemplateFilter) -> Unit,
    val onTemplateSort: (AutomationTemplateSort) -> Unit,
    val onArchiveBlueprint: (StableId) -> Unit,
    ...
    val onNthWeekday: (DayOfWeek) -> Unit,
