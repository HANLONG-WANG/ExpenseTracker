...
public object LocaleNumberFormatter {
    public fun decimal(value: BigDecimal, locale: Locale, maximumFractionDigits: Int = 10): String =
    ...
    public fun percentage(value: BigDecimal, locale: Locale): String =
    ...
    public fun weights(values: List<BigDecimal>, locale: Locale): String =
        values.joinToString(" : ") { decimal(it, locale, maximumFractionDigits = 2) }
}
