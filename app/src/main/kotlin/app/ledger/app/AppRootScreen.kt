    ...
    if (screenId.startsWith("ACC-")) {
        ...
        SecurityPrivacySettingsDestination(
            ...
            SecurityPrivacySettingsActions(
                ...
                onCustomTrashRetention = viewModel::updateCustomTrashRetention,
            ),
        )
        ...
        JournalDestination(
            ...
            actions = JournalActions(
                ...
                onApplyFilter = { filter ->
                    viewModel.applyJournalFilter(filter)
                    if (screenId == "JRN-003") {
                ...
                onEdit = { transactionId, kind ->
                    viewModel.editJournalTransaction(transactionId, kind)
                    onNavigationChanged()
                },
                ...
                onApplyPreset = { presetId ->
                    viewModel.applyJournalPreset(presetId)
                    if (screenId == "JRN-004") {
                        viewModel.requestRootBack()
                        onNavigationChanged()
                    }
