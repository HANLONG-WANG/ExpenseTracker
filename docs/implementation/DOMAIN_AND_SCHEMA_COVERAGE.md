...
Stage: P22
Status meaning: `NOT_STARTED`, `IN_PROGRESS`, `IMPLEMENTED`, `VERIFIED`, `BLOCKED`. P22 verifies exact mutual-expense allocation, unique-self activities/participants, self-conditional accounting, immutable partial settlement history, canonical position/additional-settlement rebuild and REC/SET screens. It does not promote recurrence, cross-feature analytics or later workflows.
