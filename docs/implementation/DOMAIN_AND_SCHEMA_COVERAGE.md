...
| Room/SQLCipher schema, all migrations, FTS5, R*Tree, WAL plaintext and projection rebuild on device | Tech stack §§5,16; architecture §21 | IN_PROGRESS (`P07-E001`—`P07-E004`, `P08-E003`, `P17-E003`, `P18-E003`, `P25-E003`: v1 create/reopen/capabilities/leakage plus exact synchronous financial/budget/project/goal/analytics projection audit/rebuild are verified on API 36; future registered migrations retain their owning stages) |
