...
| UI-ADR-006 | Long operations share one Operation Center. | IN_PROGRESS (`P04-E003`, `P28-E006`, `P29-E006`: import and export use the governed operation-progress model/panel and shared operation-center presentation; backup/restore operation destinations remain P30—P31) |
...
|---|---|---|---|
| BACKGROUND-OPERATION | Durable operation state | `background_operation`, `operation_checkpoint`; QUEUED → PREPARING → RUNNING → PAUSED/CANCEL_REQUESTED/FAILED_* → COMMITTING/ROLLING_BACK → SUCCEEDED | VERIFIED for import/export (`P05-E001`, `P05-E002`, `P07-E001`, `P28-E001`, `P28-E002`, `P28-E004`, `P29-E001`, `P29-E004`: encrypted parameters/checkpoints, foreground/UIDT execution, pause/safe cancel/retry/crash recovery and cleanup pass; later operation types retain their owning phases) |
...
| Keystore, BiometricPrompt, SAF, location and foreground/UIDT behavior on actual devices | Tech stack §16 | IN_PROGRESS (`P09-E003`, `P09-E004`, `P10-E003`, `P10-E004`, `P28-E003`, `P28-E004`, `P29-E004`, `P29-E005`: Keystore/credential, SAF streaming/conflict/revocation, foreground location, import runtime, encrypted export recovery and API 34 remote-provider UIDT pass; backup/restore platform behaviors remain P30—P31) |
