...
|---|---|---|---|
| BACKGROUND-OPERATION | Durable operation state | `background_operation`, `operation_checkpoint`; QUEUED → PREPARING → RUNNING → PAUSED/CANCEL_REQUESTED/FAILED_* → COMMITTING/ROLLING_BACK → SUCCEEDED | VERIFIED for import/export/backup/restore (`P05-E001`, `P05-E002`, `P07-E001`, `P28-E001`, `P28-E002`, `P28-E004`, `P29-E001`, `P29-E004`, `P30-E001`, `P30-E002`, `P30-E004`, `P31-E001`—`P31-E003`: encrypted parameters/checkpoints, bounded progress, safe cancel, non-cancellable exchange, crash recovery and cleanup pass) |
