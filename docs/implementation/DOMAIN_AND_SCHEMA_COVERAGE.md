...
Stage: P18
Status meaning: `NOT_STARTED`, `IN_PROGRESS`, `IMPLEMENTED`, `VERIFIED`, `BLOCKED`. P18 verifies project and goal-fund aggregates, immutable ProjectEffect/GoalMovement/GoalEffect facts, synchronous project/goal projections, keyset project queries and PRJ-001—006/GOL-001—005. It does not promote recurrence authoring, settlement management, cross-feature analytics or later workflows.
