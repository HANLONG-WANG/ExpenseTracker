...
Stage: P19
Status meaning: `NOT_STARTED`, `IN_PROGRESS`, `IMPLEMENTED`, `VERIFIED`, `BLOCKED`. P19 verifies credit profiles/statements, immutable repayment/allocation facts, synchronous credit projections, automatic bookkeeping eligibility/idempotency and REC-014/CRD-001—008. It does not promote P23 occurrence scheduling, installments, loans, cross-feature analytics or later workflows.
...
| INV-028 | Candidate records create no formal financial effects. | Domain/database/report tests | IN_PROGRESS (`P06-E001`, `P06-E002`, `P19-E002`, `P19-E003`: credit candidate mode is proven fact-free through domain and SQLCipher application tests; recurrence candidate persistence/report evidence remains P23) |
...
|---|---|---|
| Pure domain property suite for accounting, refunds, FX, loans, installments, budget, settlement, expressions and recurrence | Tech stack §16; architecture §21 | IN_PROGRESS (`P03-E002`—`P03-E005`, `P05-E002`, `P06-E001`—`P06-E003`, `P16-E002`, `P17-E002`, `P18-E002`: accounting/refund rules, 1,000 generated budget hierarchies, 122-month rollover and 1,000 checked goal-availability cases are verified; later loan/installment/settlement/recurrence integration remains) |
| Room/SQLCipher schema, all migrations, FTS5, R*Tree, WAL plaintext and projection rebuild on device | Tech stack §§5,16; architecture §21 | IN_PROGRESS (`P07-E001`—`P07-E004`, `P08-E003`, `P17-E003`, `P18-E003`: v1 create/reopen/capabilities/leakage and exact synchronous financial/budget/project/goal projection audit/rebuild are verified on API 36; future registered migrations retain their owning stages) |
