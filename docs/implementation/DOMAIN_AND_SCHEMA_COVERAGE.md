...
Stage: P20
Status meaning: `NOT_STARTED`, `IN_PROGRESS`, `IMPLEMENTED`, `VERIFIED`, `BLOCKED`. P20 verifies purchase-linked installments, immutable plan/schedule revisions, exact principal/cost calculations, explicit settlement/refund application, synchronous progress projection and REC-027/INS-001—006. It does not promote loans, recurrence, cross-feature analytics or later workflows.
